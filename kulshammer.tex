...
\cite{kulshammer1995donovan}; in this case the maximal unipotent subgroups are the Sylow $p$-subgroups.  An example of Cram shows that the answer to Question~\ref{qn:algKQ} is no for $H= S_3$ and $G$ a certain 3-dimensional non-connected group with $G^0$ unipotent [ref: Slodowy].
